...
| ✅ **[TODO.md](TODO.md)** | **Start here.** Every remaining task in order — yours vs Cursor's, with acceptance criteria and paste-ready prompts. |
| 🚀 **[HANDOFF.md](HANDOFF.md)** | The 45-minute path to a live listing. |
